...
const autotraderReviews = [
  {
    quote:
      "Great garage to buy a car from. Small deposit taken, held the car for us for a few weeks and everything was ready and spotless on the day of collection.",
    author: "Andrea T.",
    source: "Autotrader",
    rating: 5,
  },
  {
    quote:
      "Really helpful. Answered every question I had about the car, arranged a proper prep and a full valet before I collected. Genuinely happy with the whole experience.",
    author: "James H.",
    source: "Autotrader",
    rating: 5,
  },
  {
    quote:
      "Friendly, professional and no pressure at any point. Would happily recommend to anyone looking for a used car.",
    author: "Helmut S.",
    source: "Autotrader",
    rating: 5,
  },
  {
    quote:
      "Test drive arranged around my work, honest answers on the small things I noticed, and a fair price without any of the usual haggling nonsense.",
    author: "Priya K.",
    source: "Autotrader",
    rating: 5,
  },
      ...
      <section className="border-b bg-white py-16 sm:py-20">
        <div className="container-shell">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-foreground/65">
          ...
          <ul className="mx-auto mt-10 flex flex-wrap items-center justify-center gap-5">
            <li>
              <AwardBadge
          ...
          <div className="mx-auto mt-12 max-w-3xl">
            <ReviewsCarousel reviews={autotraderReviews} />
          </div>
          ...
          <div className="mt-8 flex flex-col items-center gap-3">
            ...
            >
              Read every review on Autotrader
            </a>
            <p className="max-w-3xl text-center text-xs leading-6 text-foreground/45">
