...
export async function PATCH(
  ...
  const mapping: Record<string, string> = {
    ...
    interiorMaterial: "interior_material",
    fuelConsumptionUrbanMpg: "fuel_consumption_urban_mpg",
    fuelConsumptionExtraUrbanMpg: "fuel_consumption_extra_urban_mpg",
    fuelConsumptionCombinedMpg: "fuel_consumption_combined_mpg",
    euroEmissionsStandard: "euro_emissions_standard",
    insuranceGroup: "insurance_group",
    roadTaxAnnual: "road_tax_annual",
    ulezStatus: "ulez_status",
    wheelchairAccessible: "wheelchair_accessible",
    acceleration060Seconds: "acceleration_0_60_seconds",
    topSpeedMph: "top_speed_mph",
    torqueLbFt: "torque_lb_ft",
    ...
    lengthMm: "length_mm",
    widthMm: "width_mm",
    keeperStartDate: "keeper_start_date",
    acquiredAt: "acquired_at",
    advertisedCondition: "advertised_condition",
    insuranceWriteOffCategory: "insurance_write_off_category",
    serviceHistoryVisible: "service_history_visible",
    serviceHistorySummary: "service_history_summary",
    silentSalesmanHeadline: "silent_salesman_headline",
    silentSalesmanSummary: "silent_salesman_summary",
    silentSalesmanCallToAction: "silent_salesman_call_to_action",
  };
