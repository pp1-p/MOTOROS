export type AdminVehicle = {
  ...
  fuelConsumptionUrbanMpg?: number | null;
  fuelConsumptionExtraUrbanMpg?: number | null;
  fuelConsumptionCombinedMpg?: number | null;
  euroEmissionsStandard?: string | null;
  insuranceGroup?: string | null;
  roadTaxAnnual?: number | null;
  ulezStatus?: string | null;
  wheelchairAccessible?: boolean | null;
  acceleration060Seconds?: number | null;
  ...
  advertisedCondition?: string | null;
  insuranceWriteOffCategory?: string | null;
  serviceHistoryVisible?: boolean;
  serviceHistorySummary?: string | null;
  silentSalesmanHeadline?: string | null;
  silentSalesmanSummary?: string | null;
  silentSalesmanCallToAction?: string | null;
  standardEquipment?: string[];
  optionalEquipment?: string[];
  videoUrl?: string | null;
  autotraderPublicationStatus?: string | null;
  autotraderStockId?: string | null;
  autotraderReference?: string | null;
};
